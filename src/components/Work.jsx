        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 ">
          ...
          {project.map((item, index) => (
            <div
              ...
              flex justify-center text-center items-center mx-auto content-div bg-gray-700 px-2"
            >
              <div>
                ...
                <div className="pt-8 text-center">
                  {/* only works when i put the link */}
                  {item.github && (
                  ...
                  {/* Render the "Live" button if live link exists */}
                  {item.live && (
